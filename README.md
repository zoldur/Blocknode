# [Blocknode](https://blocknode.tech) - The future of rewards.  

Shell script to install a Blocknode Masternodeon a Linux server running Ubuntu 16.04. Use it on your own risk.
***
