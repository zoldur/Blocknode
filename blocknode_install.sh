...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='blocknode.conf'
CONFIGFOLDER='/root/.blocknode'
COIN_DAEMON='blocknoded'
COIN_CLI='blocknode-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/blocknodetech/blocknode/releases/download/v1.3.11/blocknode-1.3.11-x86_64-linux-gnu.tar.gz'
